...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMenu}
        className="relative p-2 text-white hover:text-santa focus:outline-none z-[60] bg-white/10 backdrop-blur-sm rounded-lg"
      ...
      {/* Mobile Menu Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-[60] transform transition-transform duration-300 ease-in-out overflow-y-auto ${
