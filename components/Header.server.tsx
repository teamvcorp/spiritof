  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-4 overflow-hidden" style={{
      ...
      {isMobile ? (
        ...
        <div className="relative flex items-center justify-between gap-12 z-10 w-full">
          ...
          <div className="fixed  left-1/2 transform -translate-x-1/2  z-50">
            <div className="flex  gap-6">
              ...
              <Link
                href="/"
                className="relative px-6 py-2 min-w-[12rem] rounded-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg overflow-hidden group flex items-center justify-center"
                style={{
